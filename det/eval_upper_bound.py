'''
Evaluate the upper bouand in streaming detetcion
based on: https://github.com/mtli/sAP/blob/master/det/eval_coco_fmt.py
'''
...
def parse_args():
    ...
    parser.add_argument('--out-dir', type=str, required=True) # save the output
...
def main():
    ...
    if opts.eval_mask:
        ...
        eval_summary = eval_ccf(db, result_path, iou_type='segm')
